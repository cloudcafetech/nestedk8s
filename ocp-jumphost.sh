...
address=/$WOR1/$WOR1IP
address=/$WOR2/$WOR2IP
address=/$JUMP.$CTX.$DOMAIN/$JUMPIP
address=/$BOOT.$CTX.$DOMAIN/$BOOTIP
address=/$MAS1.$CTX.$DOMAIN/$MAS1IP
address=/$MAS2.$CTX.$DOMAIN/$MAS2IP
address=/$MAS3.$CTX.$DOMAIN/$MAS3IP
address=/$INF1.$CTX.$DOMAIN/$INF1IP
address=/$INF2.$CTX.$DOMAIN/$INF2IP
address=/$WOR1.$CTX.$DOMAIN/$WOR1IP
address=/$WOR2.$CTX.$DOMAIN/$WOR2IP
